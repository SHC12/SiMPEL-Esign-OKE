...
/*
                ...
                if(editTanggal.getText().toString().length() == 0 || c == "" ){
                    progressDialog.dismiss();
                    Toast.makeText(BuatDisposisiSM.this, "Penerima Disposisi atau Tanggal Selesai tidak boleh kosong", Toast.LENGTH_SHORT).show();
