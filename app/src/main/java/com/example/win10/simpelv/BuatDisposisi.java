...
import com.example.win10.simpelv.data.DataSpinnerPenerimaDisposisi;
...
/*
                ...
                if(editTanggal.getText().toString().length() == 0 || e == "" ){
                    progressDialog.dismiss();
                    Toast.makeText(BuatDisposisi.this, "Penerima Disposisi atau Tanggal Selesai tidak boleh kosong", Toast.LENGTH_SHORT).show();
...
//                    JSONArray jsonArray = jsonObject.getJSONArray("response");
                    if (success.equals("1")) {
                        Toast.makeText(BuatDisposisi.this,
                                "Sukses ",
                                Toast.LENGTH_SHORT)
                                .show();
