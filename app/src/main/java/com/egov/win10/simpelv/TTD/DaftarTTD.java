...
public class DaftarTTD extends AppCompatActivity {
    ...
    String a = "http://simpel.pasamanbaratkab.go.id/upload/a.jpg";
        ...
        if(stat_code2.equals("null")){
            ...
            btnDaftar.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    API_DAFTAR_TTD = URL_DAFTAR_TTD + nik + "&nama="+nama+"&email="+email+"&nomor_telepon="+noTelepon+"&kota="+kota+"&provinsi="+provinsi+"&nip="+nip+"&jabatan="+jabatan+"&unit_kerja="+unitkerja;
                    // Toast.makeText(DaftarTTD.this, ""+API_DAFTAR_TTD, Toast.LENGTH_SHORT).show();
    ...
    public void signUp(final String nikk, final String namaa, final String id_userr, final String nama_instansii) {
        ...
        AndroidNetworking.upload(API_DAFTAR_TTD)
    ...
    public void upload_image_ttd(){
        ...
        AndroidNetworking.upload("http://simpel.pasamanbaratkab.go.id/api_android/simaya/upload_image_ttd.php")
                .addMultipartFile("image_ttd", scanTTD)
    ...
    public void auth(final String ktp, final String sk, final String ttd) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, API_DAFTAR_TTD, new Response.Listener<String>() {
            @Override
    ...
    public void daftar() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, API_DAFTAR_TTD, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
