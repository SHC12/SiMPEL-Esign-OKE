...
public class DetailAgendaMasuk extends AppCompatActivity {
    ...
    String token_surat, no_surat_keluar, tgl_suratt, penerima, pengirimm, judul_suratt, nota_dinas, no_agenda, id_surat, perihall, tgl_penerima_suratt;

    TextView no_agenda_surat_keluar, no_surat, tujuan, tgl_penerimaan, tgl_surat, pengirim, jenis_nota_dinas, judul_surat, perihal, tgl_penerima_surat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_agenda_masuk);

        StrictMode.VmPolicy.Builder builder = new StrictMode.VmPolicy.Builder();
        StrictMode.setVmPolicy(builder.build());

        progressDialog = new ProgressDialog(DetailAgendaMasuk.this);
        progressDialog.setMessage("Loading....");
        progressDialog.setCancelable(false);
        progressDialog.show();

        no_agenda_surat_keluar = (TextView) findViewById(R.id.tv_hasil_nomor_agenda_surat_keluar3_AM);
        no_surat = (TextView) findViewById(R.id.tv_hasil_nomor_surat_keluar3_AM);
        tujuan = (TextView) findViewById(R.id.tv_hasil_tujuan_surat_keluar3_AM);
        tgl_surat = (TextView) findViewById(R.id.tv_hasil_tanggal_surat_keluar3_AM);
        pengirim = (TextView) findViewById(R.id.tv_hasil_pengirim_surat_keluar3_AM);
        jenis_nota_dinas = (TextView) findViewById(R.id.tv_hasil_jenis_nota_dinas_surat_keluar3_AM);
        judul_surat = (TextView) findViewById(R.id.tv_hasil_judul_surat_keluar3_AM);
        perihal = (TextView) findViewById(R.id.tv_hasil_perihal_surat_keluar3_AM);
        tgl_penerima_surat = (TextView) findViewById(R.id.tv_hasil_tanggal_penerimaan_surat_keluar3_AM);
        btnBukaSurat = (Button) findViewById(R.id.btnBukaSuratSuratKeluar_AM);
        ...
        no_surat_keluar = getIntent().getStringExtra("no_surat");
        tgl_suratt = getIntent().getStringExtra("tanggal_surat");
        tgl_penerima_suratt = getIntent().getStringExtra("tanggal_surat_masuk");
        pengirimm = getIntent().getStringExtra("pengirim");
        ...
        tgl_penerima_surat.setText(tgl_penerima_suratt);
