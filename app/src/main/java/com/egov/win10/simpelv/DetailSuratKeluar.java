...
public class DetailSuratKeluar extends AppCompatActivity {
    ...
    String token_surat, no_surat_keluar, tgl_suratt, penerima, pengirimm, judul_suratt, nota_dinas, no_agenda, id_surat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(DetailSuratKeluar.this);
        progressDialog.setMessage("Loading....");
        progressDialog.setCancelable(false);
        progressDialog.show();

        no_agenda_surat_keluar = (TextView) findViewById(R.id.tv_hasil_nomor_agenda_surat_keluar3);
        no_surat = (TextView) findViewById(R.id.tv_hasil_nomor_surat_keluar3);
        tujuan = (TextView) findViewById(R.id.tv_hasil_tujuan_surat_keluar3);
        tgl_surat = (TextView) findViewById(R.id.tv_hasil_tanggal_surat_keluar3);
        pengirim = (TextView) findViewById(R.id.tv_hasil_pengirim_surat_keluar3);
        jenis_nota_dinas = (TextView) findViewById(R.id.tv_hasil_jenis_nota_dinas_surat_keluar3);
        judul_surat = (TextView) findViewById(R.id.tv_hasil_judul_surat_keluar3);

        btnBukaSurat = (Button) findViewById(R.id.btnBukaSuratSuratKeluar);
        ...
        tgl_suratt = getIntent().getStringExtra("tgl_surat");
        pengirimm = getIntent().getStringExtra("pengirim_surat");
        penerima = getIntent().getStringExtra("penerima_surat");
        judul_suratt = getIntent().getStringExtra("judul_surat");
        nota_dinas = getIntent().getStringExtra("nota_dinas");
